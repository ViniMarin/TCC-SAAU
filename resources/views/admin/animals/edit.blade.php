...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Editar Animal: {{ $animal->name }}</h1>
            ...
            <form action="{{ route('admin.animals.update', $animal) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('species') is-invalid @enderror" 
                            ...
                            <option value="cao" {{ old('species', $animal->species) == 'cao' ? 'selected' : '' }}>Cachorro</option>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('breed') is-invalid @enderror" 
                               id="breed" name="breed" value="{{ old('breed', $animal->breed) }}">
                        @error('breed')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('age') is-invalid @enderror" 
                            ...
                            <option value="">Selecione...</option>
                            <option value="filhote" {{ old('age', $animal->age) == 'filhote' ? 'selected' : '' }}>Filhote</option>
                            <option value="adulto" {{ old('age', $animal->age) == 'adulto' ? 'selected' : '' }}>Adulto</option>
                            <option value="idoso" {{ old('age', $animal->age) == 'idoso' ? 'selected' : '' }}>Idoso</option>
                        </select>
                        @error('age')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('gender') is-invalid @enderror" 
                            ...
                            <option value="">Selecione...</option>
                            <option value="macho" {{ old('gender', $animal->gender) == 'macho' ? 'selected' : '' }}>Macho</option>
                            <option value="femea" {{ old('gender', $animal->gender) == 'femea' ? 'selected' : '' }}>Fêmea</option>
                        </select>
                        @error('gender')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('size') is-invalid @enderror" 
                                id="size" name="size">
                            <option value="">Selecione...</option>
                            <option value="pequeno" {{ old('size', $animal->size) == 'pequeno' ? 'selected' : '' }}>Pequeno</option>
                            <option value="medio" {{ old('size', $animal->size) == 'medio' ? 'selected' : '' }}>Médio</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('color') is-invalid @enderror" 
                               id="color" name="color" value="{{ old('color', $animal->color) }}">
                        @error('color')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('health_status') is-invalid @enderror" 
                              id="health_status" name="health_status" rows="2">{{ old('health_status', $animal->health_status) }}</textarea>
                    @error('health_status')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="castrated" name="castrated" value="1" {{ old('castrated', $animal->castrated) ? 'checked' : '' }}>
                                <label class="form-check-label" for="castrated">Castrado</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="vaccinated" name="vaccinated" value="1" {{ old('vaccinated', $animal->vaccinated) ? 'checked' : '' }}>
                                <label class="form-check-label" for="vaccinated">Vacinado</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="dewormed" name="dewormed" value="1" {{ old('dewormed', $animal->dewormed) ? 'checked' : '' }}>
                                <label class="form-check-label" for="dewormed">Vermifugado</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="special_needs" name="special_needs" value="1" {{ old('special_needs', $animal->special_needs) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" 
                        ...
                        <option value="em_tratamento" {{ old('status', $animal->status) == 'em_tratamento' ? 'selected' : '' }}>Em Tratamento</option>
                    </select>
                    @error('status')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    <label for="photo" class="form-label">{{ $animal->photo_url ? 'Alterar Foto' : 'Adicionar Foto' }}</label>
