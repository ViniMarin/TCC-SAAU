...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
            <a href="{{ route('admin.raffles.index') }}" class="text-decoration-none text-secondary d-inline-flex align-items-center mb-2">
                <i class="fas fa-arrow-left me-2"></i> Voltar para a lista
            </a>
            <h1 class="mb-1">{{ $raffle->title }}</h1>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-3 text-center">
                <div class="card-body">
                    @if($raffle->image_url)
                    <img src="{{ $raffle->image_url }}" alt="{{ $raffle->title }}" class="img-fluid rounded mb-3" style="max-height: 240px; object-fit: cover;">
                    @else
                    ...
                    <div class="d-grid gap-2 text-start">
                        ...
                        <div class="border rounded-3 p-2 bg-light d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold mb-0">{{ \Carbon\Carbon::parse($raffle->draw_date)->format('d/m/Y') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold">{{ $raffle->created_at?->format('d/m/Y H:i') }}</div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold">{{ $raffle->updated_at?->format('d/m/Y H:i') }}</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start gap-2 mb-1">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">{{ $raffle->total_tickets }}</h5>
                                </div>
                            </div>
