                ...
                <ul class="navbar-nav ms-auto align-items-center gap-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('stories.index') }}">Histórias</a></li>
                            <li><a class="dropdown-item" href="{{ route('how-it-works') }}">Como Funciona</a></li>
                            <li><a class="dropdown-item" href="{{ route('how-to-help') }}">Como Ajudar</a></li>
                    ...
                    @auth
                        ...
                        <li class="nav-item dropdown ms-lg-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="{{ route('animals') }}">Quero adotar</a></li>
                    ...
                    @else
                        <li class="nav-item ms-lg-2">
                            <a class="btn btn-login-fixed px-4 rounded-pill" href="{{ route('login') }}">
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="{{ route('home') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>Início</a></li>
                        <li class="mb-2"><a href="{{ route('animals') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>Quero Adotar</a></li>
                        <li class="mb-2"><a href="{{ route('how-to-help') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>Como Ajudar</a></li>
                        <li class="mb-2"><a href="{{ route('events') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>Eventos</a></li>
                        <li class="mb-2"><a href="{{ route('stories.index') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>Histórias de Sucesso</a></li>
                        <li class="mb-2"><a href="{{ route('faq') }}" class="text-decoration-none"><i class="fas fa-chevron-right small me-2 opacity-50"></i>FAQ</a></li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <small class="opacity-75">&copy; {{ date('Y') }} SAAU. Todos os direitos reservados.</small>
                </div>
