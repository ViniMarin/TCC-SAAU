...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            {{-- DASHBOARD – todos os perfis enxergam --}}
            <li>
            ...
            {{-- GERENCIAMENTO (todos têm algo aqui) --}}
            <li class="text-uppercase small fw-bold text-white-50 px-4 mt-3 mb-2">Gerenciamento</li>
            
            {{-- Animais – admin, vet e usuario --}}
            @if(in_array($role, ['admin', 'veterinario', 'usuario']))
            <li>
            ...
            {{-- Pedidos de Adoção – apenas admin --}}
            @if($role === 'admin')
            <li>
            ...
            {{-- Vacinas – admin e vet --}}
            @if(in_array($role, ['admin', 'veterinario']))
            <li>
            ...
            {{-- Histórias – admin e usuário comum --}}
            ...
            {{-- EVENTOS & FINANCEIRO – admin e usuário comum --}}
            @if(in_array($role, ['admin', 'usuario']))
