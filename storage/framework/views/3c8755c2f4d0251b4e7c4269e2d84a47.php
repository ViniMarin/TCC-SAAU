...
<div class="content-card">
    <div class="card-header">
        ...
        <a href="<?php echo e(route('admin.vaccines.index')); ?>" class="btn btn-secondary btn-sm">
            <i class="fas fa-arrow-left me-1"></i> Voltar
        </a>
    </div>

    <form action="<?php echo e(route('admin.vaccines.update', $vaccine->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                ...
                <option value="<?php echo e($animal->id); ?>" <?php echo e(old('animal_id', $vaccine->animal_id) == $animal->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                   id="vaccine_type" name="vaccine_type" value="<?php echo e(old('vaccine_type', $vaccine->vaccine_type)); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                       id="application_date" name="application_date" value="<?php echo e(old('application_date', optional($vaccine->application_date)->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                       id="next_dose_date" name="next_dose_date" value="<?php echo e(old('next_dose_date', optional($vaccine->next_dose_date)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                      id="notes" name="notes" rows="3"><?php echo e(old('notes', $vaccine->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\eutei\OneDrive\Área de Trabalho\alterações do antonio\TCC-SAAU\resources\views/admin/vaccines/edit.blade.php ENDPATH**/ ?>