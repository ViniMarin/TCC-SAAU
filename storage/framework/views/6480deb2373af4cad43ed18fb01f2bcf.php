...
<body>
    ...
    <aside class="admin-sidebar">
        <div class="sidebar-header">
            ...
            <div class="sidebar-user"><?php echo e(auth()->user()->name); ?></div>
        </div>
...
<?php /**PATH C:\Users\Marin\Downloads\saau-final-corrigido\saau-final\resources\views/layouts/admin.blade.php ENDPATH**/ ?>