...
<div class="container my-5">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('admin.raffles.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="prize" name="prize" value="<?php echo e(old('prize')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   id="ticket_price" name="ticket_price" value="<?php echo e(old('ticket_price', '0,00')); ?>" required>
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                               id="total_tickets" name="total_tickets" value="<?php echo e(old('total_tickets')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="ativa" <?php echo e(old('status') == 'ativa' ? 'selected' : ''); ?>>Ativa</option>
                            <option value="pausada" <?php echo e(old('status') == 'pausada' ? 'selected' : ''); ?>>Pausada</option>
                            <option value="encerrada" <?php echo e(old('status') == 'encerrada' ? 'selected' : ''); ?>>Encerrada</option>
                        </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\eutei\OneDrive\Área de Trabalho\alterações do antonio\TCC-SAAU\resources\views/admin/raffles/create.blade.php ENDPATH**/ ?>