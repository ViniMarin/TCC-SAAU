...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
            <a href="<?php echo e(route('admin.donations.index')); ?>" class="text-decoration-none text-secondary d-inline-flex align-items-center mb-2">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 text-success fw-bold">R$ <?php echo e(number_format($donation->amount, 2, ',', '.')); ?></h3>
                            <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($donation->date)->format('d/m/Y')); ?></small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold text-capitalize"><?php echo e($donation->type); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start gap-2 mb-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold"><?php echo e($donation->created_at?->format('d/m/Y H:i')); ?></div>
                            <small class="text-muted">Última atualização: <?php echo e($donation->updated_at?->format('d/m/Y H:i')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="border rounded-3 p-3 h-100 bg-light-subtle">
                                ...
                                <div class="fw-semibold"><?php echo e($donation->donor_name ?? 'Anônimo'); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="border rounded-3 p-3 h-100 bg-light-subtle">
                                <small class="text-uppercase text-muted">Email</small>
                                <div class="fw-semibold"><?php echo e($donation->donor_email ?? 'Email não informado'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <p class="mb-0"><?php echo nl2br(e($donation->description ?? 'Nenhuma descrição informada.')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\eutei\OneDrive\Área de Trabalho\alterações do antonio\TCC-SAAU\resources\views/admin/donations/show.blade.php ENDPATH**/ ?>