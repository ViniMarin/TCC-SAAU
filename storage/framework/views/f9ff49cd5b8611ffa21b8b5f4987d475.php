...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
            <a href="<?php echo e(route('admin.events.index')); ?>" class="text-decoration-none text-secondary d-inline-flex align-items-center mb-2">
                <i class="fas fa-arrow-left me-2"></i> Voltar para a lista
            </a>
            <h1 class="mb-1"><?php echo e($event->title); ?></h1>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-3 text-center">
                <div class="card-body">
                    ...
                    <img src="<?php echo e($event->image_url); ?>" alt="<?php echo e($event->title); ?>" class="img-fluid rounded mb-3" style="max-height: 240px; object-fit: cover;">
                    <?php else: ?>
                    ...
                    <div class="d-grid gap-2 text-start">
                        <div class="border rounded-3 p-2 bg-light d-flex align-items-center gap-2">
                            <span class="bg-<?php echo e($event->active ? 'success-subtle text-success' : 'secondary-subtle text-secondary'); ?> rounded-3 d-inline-flex align-items-center justify-content-center" style="width: 32px; height: 32px;"><i class="fas fa-flag"></i></span>
                            <div>
                                <small class="text-uppercase text-muted">Status</small>
                                <div class="fw-semibold mb-0"><?php echo e($event->active ? 'Ativo' : 'Inativo'); ?></div>
                            </div>
                        </div>
                        <div class="border rounded-3 p-2 bg-light d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold mb-0"><?php echo e(\Carbon\Carbon::parse($event->date)->format('d/m/Y')); ?></div>
                            </div>
                        </div>
                        <div class="border rounded-3 p-2 bg-light d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <div class="fw-semibold mb-0"><?php echo e($event->location ?? '-'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold"><?php echo e($event->created_at?->format('d/m/Y H:i')); ?></div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="fw-semibold"><?php echo e($event->updated_at?->format('d/m/Y H:i')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-body">
                    ...
                    <p class="mb-0"><?php echo nl2br(e($event->description ?? 'Nenhuma descrição informada.')); ?></p>
                </div>
            </div>
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-3">
                        <div class="border rounded-3 p-3 bg-white shadow-sm">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <div>
                                    <small class="text-uppercase text-muted fw-semibold">Criado em</small>
                                    <div class="fw-semibold mb-0"><?php echo e($event->created_at?->format('d/m/Y H:i')); ?></div>
                                </div>
                            </div>
                        ...
                        <div class="border rounded-3 p-3 bg-white shadow-sm">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <div>
                                    <small class="text-uppercase text-muted fw-semibold">Última atualização</small>
                                    <div class="fw-semibold mb-0"><?php echo e($event->updated_at?->format('d/m/Y H:i')); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\eutei\OneDrive\Área de Trabalho\alterações do antonio\TCC-SAAU\resources\views/admin/events/show.blade.php ENDPATH**/ ?>